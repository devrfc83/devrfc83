  ...
  inset: (left: 2.1cm, right: 2.1cm, top: 1.3cm, bottom: 1.1cm),
  {
    grid(
      ...
      stack(
        ...
        v(11pt),
        text(size: 11pt, fill: teal-soft, tracking: 0.4pt, "Enginyer en Computació i Informàtica"),
      ),
      box(
        width: 2.5cm,
        height: 2.5cm,
    ...
    grid(
      ...
      [#text(fill: teal-soft, weight: "bold")[Correu] #h(3pt) devrfc83\@gmail.com],
      [#text(fill: teal-soft, weight: "bold")[Ubicació] #h(3pt) Talca, Maule, Xile],
...
#grid(
  ...
  block(
    ...
    {
      heading-block("Educació")
      edu(
        "Enginyeria en Computació i Informàtica",
        "Universidad Andrés Bello",
        "Graduat amb Distinció Cum Laude — 2024",
      )
      edu(
      ...
      v(0.7em)
      heading-block("Idiomes")
      lang-entry("Castellà", "Natiu")
      lang-entry("Anglès", "Avançat")
      lang-entry("Alemany", "Bàsic")
      lang-entry("Italià", "Bàsic")
    }
  ),
  ...
  block(
    ...
    {
      heading-block("Experiència Rellevant")
      job(
        "Enginyer de Projectes", "Carabineros de Chile", "2022 — Present",
        desc: "Desenvolupament de sistemes que donen suport al disseny de polítiques públiques de seguretat en el marc de la Llei S.T.O.P. de Xile.",
      )
      job(
        "Soci Director", "Sea Dragon S.p.A., Chile", "2021 — Present",
        desc: "Fundació i direcció de Sea Dragon S.p.A., consultora tecnològica especialitzada en ciència de dades i enginyeria de programari.",
      )
      job(
        "Consultor TI / Data Scientist", "The Pegasus Group, Chile", "2017 — 2021",
        desc: "Desenvolupament de solucions tecnològiques a mida per a clients dels sectors públic i privat, i representació de la marca RapidMiner a Xile.",
      )
      job(
        "Desenvolupador de Programari", "Zeit.io, Alemanya", "2015 — 2016",
        desc: "Desenvolupament de sistemes per a clients de l'empresa en modalitat remota.",
      )
      job(
        "Desenvolupador de Programari", "Intellisoft, Chile", "2009 — 2014",
        desc: "Desenvolupament de sistemes SaaS (programari com a servei) per a empreses del grup: Fidelizador i ProactiveOffice.",
      )
      job(
        "Desenvolupador de Programari", "Parés y Álvarez Ingenieros Asociados, Chile", "2006 — 2007",
        desc: "Desenvolupament de sistemes d'informació per a clients interns i col·laboració en el disseny de la xarxa i el centre de dades de l'empresa.",
      )
    }
  ),
)
