  ...
  inset: (left: 2.1cm, right: 2.1cm, top: 1.3cm, bottom: 1.1cm),
  {
    grid(
      ...
      stack(
        ...
        v(11pt),
        text(size: 11pt, fill: teal-soft, tracking: 0.4pt, "Informatikingenieur"),
      ),
      box(
        width: 2.5cm,
        height: 2.5cm,
    ...
    grid(
      ...
      [#text(fill: teal-soft, weight: "bold")[Ort] #h(3pt) Talca, Maule, Chile],
...
#grid(
  ...
  block(
    ...
    {
      heading-block("Ausbildung")
      edu(
        "Informatikingenieurwesen",
        "Universidad Andrés Bello",
        "Abschluss mit Auszeichnung (Cum Laude) — 2024",
      )
      edu(
      ...
      v(0.7em)
      heading-block("Sprachen")
      lang-entry("Spanisch", "Muttersprache")
      lang-entry("Englisch", "Fortgeschritten")
      lang-entry("Deutsch", "Grundkenntnisse")
      lang-entry("Italienisch", "Grundkenntnisse")
    }
  ),
  ...
  block(
    ...
    {
      heading-block("Relevante Berufserfahrung")
      job(
        "Projektingenieur", "Carabineros de Chile", "2022 — Heute",
        desc: "Entwicklung von Systemen zur Unterstützung der Gestaltung öffentlicher Sicherheitspolitik im Rahmen des chilenischen S.T.O.P.-Gesetzes.",
      )
      job(
        "Geschäftsführender Gesellschafter", "Sea Dragon S.p.A., Chile", "2021 — Heute",
        desc: "Gründer und Geschäftsführer von Sea Dragon S.p.A., einem auf Data Science und Softwareentwicklung spezialisierten Technologieberatungsunternehmen.",
      )
      job(
        "IT-Berater / Data Scientist", "The Pegasus Group, Chile", "2017 — 2021",
        desc: "Entwicklung maßgeschneiderter Technologielösungen für Kunden aus dem öffentlichen und privaten Sektor sowie Vertretung der Marke RapidMiner in Chile.",
      )
      job(
        "Softwareentwickler", "Zeit.io, Deutschland", "2015 — 2016",
        desc: "Entwicklung von Systemen für die Kunden des Unternehmens im Remote-Modus.",
      )
      job(
        "Softwareentwickler", "Intellisoft, Chile", "2009 — 2014",
        desc: "Entwicklung von SaaS-Systemen (Software as a Service) für die Unternehmen der Holding: Fidelizador und ProactiveOffice.",
      )
      job(
        "Softwareentwickler", "Parés y Álvarez Ingenieros Asociados, Chile", "2006 — 2007",
        desc: "Entwicklung von Informationssystemen für interne Kunden sowie Mitwirkung an der Planung des Unternehmensnetzwerks und Rechenzentrums.",
      )
    }
  ),
)
