  ...
  inset: (left: 2.1cm, right: 2.1cm, top: 1.3cm, bottom: 1.1cm),
  {
    grid(
      ...
      stack(
        ...
        v(11pt),
        text(size: 11pt, fill: teal-soft, tracking: 0.4pt, "Ingeniero en Computación e Informática"),
      ),
      box(
        width: 2.5cm,
        height: 2.5cm,
    ...
    grid(
      ...
      [#text(fill: teal-soft, weight: "bold")[Ubicación] #h(3pt) Talca, Maule, Chile],
...
#grid(
  ...
  block(
    ...
    {
      heading-block("Educación")
      edu(
        "Ingeniero en Computación e Informática",
        "Universidad Andrés Bello",
        "Graduado con Distinción Cum Laude — 2024",
      )
      edu(
      ...
      lang-entry("Castellano", "Nativo")
      lang-entry("Inglés", "Avanzado")
      lang-entry("Alemán", "Básico")
  ...
  block(
    ...
    {
      heading-block("Experiencia Relevante")
      job(
        "Ingeniero de Proyectos", "Carabineros de Chile", "2022 — Presente",
        desc: "Desarrollo de sistemas que apoyan el diseño de políticas públicas de seguridad en el marco de la Ley S.T.O.P.",
      )
      job(
        "Socio Director", "Sea Dragon S.p.A., Chile", "2021 — Presente",
        desc: "Fundación y dirección de Sea Dragon S.p.A., consultora tecnológica especializada en ciencia de datos e ingeniería de software.",
      )
      job(
        "Consultor TI / Data Scientist", "The Pegasus Group, Chile", "2017 — 2021",
        desc: "Desarrollo de soluciones tecnológicas a medida para clientes de los sectores público y privado, y representación de la marca RapidMiner en Chile.",
      )
      job(
        "Desarrollador de Software", "Zeit.io, Alemania", "2015 — 2016",
        desc: "Desarrollo de sistemas para clientes de la empresa en modalidad remota.",
      )
      job(
        "Desarrollador de Software", "Intellisoft, Chile", "2009 — 2014",
        desc: "Desarrollo de sistemas SaaS (software como servicio) para empresas del holding: Fidelizador y ProactiveOffice.",
      )
      job(
        "Desarrollador de Software", "Parés y Álvarez Ingenieros Asociados, Chile", "2006 — 2007",
        desc: "Desarrollo de sistemas de información para clientes internos y colaboración en el diseño de la red y el centro de datos de la empresa.",
      )
    }
  ),
)
